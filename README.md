...
This repository contains the official landing page developed to present the project, its features, workflow, and team members.

## ✨ Features

- Modern and responsive UI design
- Project overview and workflow explanation
- Smart accident detection showcase
- Real-time emergency response presentation
...
For feedback, collaboration, or project inquiries:

- Email: salamti.dev@gmail.com
